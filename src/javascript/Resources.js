...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'introDBase', source: './models/intro/h/base.glb' },
            { name: 'introDCollision', source: './models/intro/h/collision.glb' },

            { name: 'introHBase', source: './models/intro/a/base.glb' },
            { name: 'introHCollision', source: './models/intro/a/collision.glb' },

            { name: 'introABase', source: './models/intro/s/base.glb' },
            { name: 'introACollision', source: './models/intro/s/collision.glb' },

            { name: 'introNBase', source: './models/intro/s/base.glb' },
            { name: 'introNCollision', source: './models/intro/s/collision.glb' },
            

            { name: 'introUBase', source: './models/intro/n/base.glb' },
            { name: 'introUCollision', source: './models/intro/a/collision.glb' },

            { name: 'introNBase', source: './models/intro/a/base.glb' },
            { name: 'introNCollision', source: './models/intro/a/collision.glb' },

            { name: 'introOBase', source: './models/intro/n/base.glb' },
            { name: 'introOCollision', source: './models/intro/n/collision.glb' },
