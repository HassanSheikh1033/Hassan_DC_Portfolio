...
export default class ProjectsSection
{
    ...
    setList()
    {
        this.list = [
            ...
            //     link:
            //     {
            //         href: 'http://my-little-city.vercel.app',
            //         x: - 4.8,
            //         y: - 2,
            //         halfExtents:
            //         {
          ...
          
            {
                ...
                link:
                {
                    href: 'https://github.com/HassanSheikh1033/Healthcare',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/HassanSheikh1033/Saeed-Electric-Project',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
...

            {
                ...
                link:
                {
                    href: 'https://food-app-threejs.vercel.app/',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
